...
namespace PlasmaPeasant
{
    class HealthBar
    {
        ...
        public HealthBar(int maxHealth, int xPos, int yPos, int height)
        {
            ...
            healthRect = new Rectangle(xPos + 4, yPos + 4, maxHealth * 2, height);
            barRect = new Rectangle(xPos, yPos, maxHealth * 2 + 8, height + 8);
        }
        ...
        {
            barRect = new Rectangle(xPos, yPos, maxHealth * 6 + 8, height + 8);
            healthRect = new Rectangle(xPos + 4, yPos + 4, currentHealth * 6, height);
        }
    }
}
